          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardHeader>
                ...
                <CardTitle>5+ Years Experience</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle>50+ Projects Delivered</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">contact@didirexha.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center">
            ...
            <Card className="p-6">
              <form className="space-y-4" onSubmit={e => {
                ...
                const text = `Name: ${firstName} ${lastName}%0AEmail: ${email}%0ASubject: ${subject}%0AMessage: ${message}`;
                const phone = '38348222209';
                ...
                <div className="space-y-2">
                  ...
                  <Textarea name="message" placeholder="Tell me about your project..." className="min-h-[120px]" />
                </div>
